...
5. **Write design doc** — save to `docs/plans/<feature-name>/YYYY-MM-DD-<topic>-design.md` and commit
...
**Documentation:**
- Write the validated design to `docs/plans/<feature-name>/YYYY-MM-DD-<topic>-design.md`
